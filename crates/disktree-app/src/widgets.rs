...
//!
//! Everything is built from the active theme's tokens, and every piece
//! is a plain function over borrowed data so the screens stay readable.

use crate::controls::{Status, keycap};
...
use crate::ui::{radius, space, text};
...
/// A small chip, used for counts and states.
